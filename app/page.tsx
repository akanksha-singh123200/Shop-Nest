...
export default async function Home() {
  ...
  return (
    <main>
      ...
      >
        {/* Bottom Soft Fade */}
        <div className="pointer-events-none absolute bottom-0 left-0 right-0 z-10 h-40 bg-gradient-to-b from-transparent via-[#fff4ed]/70 to-[#fff8f3]"></div>
        ...
        {/* Hero Content */}
        <div className="relative mt-12 z-10 mx-auto flex min-h-screen max-w-7xl items-start px-6 md:px-10">
          <div className="max-w-2xl">

            <span className="inline-block rounded-full bg-white/20 px-4 py-2 text-sm font-medium text-black backdrop-blur-sm">
              ✨ New Collection
            </span>

            <h1 className="text-4xl font-extrabold leading-tight text-black sm:text-5xl md:text-6xl">
              Shop The
              <br />
              Latest Trends
            </h1>
            ...
            <div className="mt-8 flex flex-wrap gap-4">
              ...
              <button className="rounded-full border border-white/70 bg-white/10 px-7 py-3.5 font-semibold text-white backdrop-blur-sm transition hover:bg-white hover:text-black">
                Explore Products
              </button>
            </div>
